...
VL_ATTR_COLD void VComputer_PipelineCPU___stl_sequent__TOP__Computer__m_core0__0(VComputer_PipelineCPU* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VComputer_PipelineCPU___stl_sequent__TOP__Computer__m_core0__0\n"); );
    ...
    vlSelfRef.__PVT__m_MUL_DIV_top__DOT__m_SRTDivider__DOT__neg_q[0xfU] 
        = vlSelfRef.m_MUL_DIV_top__DOT__m_SRTDivider__DOT____Vcellout__m_QuotientSelects__BRA__15__KET____DOT__m_QuotientSelect__neg_q_o;
    if (vlSelfRef.__PVT__u_mmu__DOT__MMU__DOT__dtlb_req) {
        ...
        vlSelfRef.u_mmu__DOT____Vcellinp__MMU__DOT__DTLB__update_i = 0U;
        vlSelfRef.__PVT__u_mmu__DOT__MMU__DOT__ptw_req_addr_r 
            = vlSelfRef.__PVT__pc_out;
    }
}
...
VL_ATTR_COLD void VComputer_PipelineCPU___stl_sequent__TOP__Computer__m_core0__1(VComputer_PipelineCPU* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VComputer_PipelineCPU___stl_sequent__TOP__Computer__m_core0__1\n"); );
    VComputer__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
